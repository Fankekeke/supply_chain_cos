    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="storehouseData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>物料类型：</b>
          <span v-if="storehouseData.materialType === 1">电容</span>
          <span v-if="storehouseData.materialType === 2">微控制器</span>
          <span v-if="storehouseData.materialType === 3">滤波器</span>
          <span v-if="storehouseData.materialType === 4">连接器</span>
        </a-col>
        <a-col :span="8"><b>物料类型：</b>
