<template>
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      <div class="operator">
        <a-button type="primary" ghost @click="add">添加原件出库</a-button>
...
export default {
  ...
  methods: {
    downLoad (row) {
      ...
      this.$get(`/cos/order-raw-info/export/${row.code}`).then((r) => {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/order-raw-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/order-raw-info/page', {
        ...params
      }).then((r) => {
