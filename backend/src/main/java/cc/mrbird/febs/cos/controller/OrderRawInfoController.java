 ...
 */
@RestController
@RequestMapping("/cos/order-raw-info")
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
public class OrderRawInfoController {

    private final IOrderRawInfoService orderInfoService;
     ...
     */
    @GetMapping("/page")
    public R page(Page<OrderRawInfo> page, OrderRawInfo orderInfo) {
     ...
     */
    @PostMapping
    public R add(OrderRawInfo orderInfo) {
     ...
     */
    @PutMapping
    public R edit(OrderRawInfo orderInfo) {
